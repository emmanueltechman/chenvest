    ...
    <?php $__env->startPush('style'); ?>
        <style>
            #hero {
                position: relative;
                padding: 170px 0;
                background-image: linear-gradient(90deg, rgba(7, 11, 40, 0.8) 0%, rgba(7, 11, 40, 0.8) 100%), url(<?php echo e(getFile(config('location.content.path').@$hero->templateMedia()->image)); ?>);
...
<?php endif; ?>
<?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\resources\views/themes/deepblue/partials/heroBanner.blade.php ENDPATH**/ ?>