...
<head>
    <title>Activate your product</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <meta content="Site Maintenance Page" name="description">
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('https://cdn.jsdelivr.net/gh/uncannyMBM/installer@v1.4/css/main.css')); ?>"/>
</head>
<body class="bg-404">
<section class="pd-5vw">
    ...
    <div class="text-height-1-5 text-grey text-size-18 dpd-20">
        To active your website please read the documentation properly.
    </div>
    <div>
        If you are unable to install it, please contact with us.
    </div>
    <br>
    <div>
        <a href="<?php echo e(config('requirements.portfolio_url')); ?>" target="_blank">Click here to buy our other items</a>
    </div>
</section>
...
</html><?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\vendor\jlang\jsonstringfy\src\Providers/../views/maintain.blade.php ENDPATH**/ ?>