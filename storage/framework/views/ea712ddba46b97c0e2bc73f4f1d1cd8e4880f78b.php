        ...
        <div class="d-flex justify-content-center">
            <div class="col-lg-6">
                <div class="heading-container">
                    <h6 class="topheading"><?php echo app('translator')->get(@$depositWithdraw->description->title); ?></h6>
                            ...
                            <div class="data-column">
                                ...
                                <div class="data-content-wrapper">
                                    <div class="media align-items-center">
                                        <img src="<?php echo e(getFile(config('location.user.path').optional($item->user)->image)); ?>" alt="Image Missing">
...
<!-- /DEPOSIT-WITHDRAW -->
<?php endif; ?>
<?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\resources\views/themes/deepblue/sections/deposit-withdraw.blade.php ENDPATH**/ ?>