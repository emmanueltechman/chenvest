    ...
    <div class="dropdown account-dropdown">
        ...
        <div class="xs-dropdown-menu dropdown-menu dropdown-right">
            ...
            <div class="pt-15 pr-15 pb-15 pl-15 d-flex justify-content-center ">
                <a class="btn-viewnotification" href="javascript:void(0)" v-if="items.length == 0"><?php echo app('translator')->get('You have no notifications'); ?></a>
                <button class="btn-clear " type="button" v-if="items.length > 0" @click.prevent="readAll"><?php echo app('translator')->get('Clear'); ?></button>
            </div>
        </div>
    </div>
</li>
...
<?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\resources\views/themes/deepblue/partials/pushNotify.blade.php ENDPATH**/ ?>