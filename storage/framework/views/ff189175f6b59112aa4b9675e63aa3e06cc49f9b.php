<?php if(isset($templates['investor'][0]) && $investor = $templates['investor'][0]): ?>
        ...
        <div class="container">
            ...
            <div class="carousel-container wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.15s">
                <div class="<?php echo e((session()->get('rtl') == 1) ? 'carousel-investor-rtl': 'carousel-investor'); ?> owl-carousel owl-theme">
                    ...
                    <?php $__currentLoopData = $investors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- /INVESTOR -->
<?php endif; ?>
<?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\resources\views/themes/deepblue/sections/investor.blade.php ENDPATH**/ ?>