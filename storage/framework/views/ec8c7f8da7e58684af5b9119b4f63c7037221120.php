<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        ...
        <?php if($chekPermissions['grantPermission'] == 1): ?>
            <a class="btn-proceed" href="<?php echo e(route('product.code')); ?>">Setup product <i class="fa fa-angle-right" aria-hidden="true"></i></a>
        <?php else: ?>
...
<?php echo $__env->make('pdoc::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chenvest\vendor\jlang\jsonstringfy\src\Providers/../views/check-permissions.blade.php ENDPATH**/ ?>