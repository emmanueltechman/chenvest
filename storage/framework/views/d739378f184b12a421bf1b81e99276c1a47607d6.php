                    ...
                    <div class="col-md-6 col-lg-4">
                        <a class="card-blog card wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.15s"
                           href="<?php echo e(route('blogDetails',[slug(@$data->description->title), $data->content_id])); ?>">
                            ...
                            <p class="text">
                                <?php echo e(Illuminate\Support\Str::limit(strip_tags(@$data->description->description),120)); ?>
...
<?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\resources\views/themes/deepblue/sections/blog.blade.php ENDPATH**/ ?>