                        ...
                        <div class="faq-card card">
                            ...
                            <div class="card-body <?php echo e(($k == 0) ? 'preview' : ''); ?> ">
                                <div class="faq-content">
                                    <p class="text">
                                        <?php echo e(trans(@$data->description->description)); ?>
...
<!-- /FAQ -->
<?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\resources\views/themes/deepblue/sections/faq.blade.php ENDPATH**/ ?>