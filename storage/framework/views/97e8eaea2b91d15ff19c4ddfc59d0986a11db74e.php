<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        ...
        <?php if(!in_array(0, $checkExtensions)): ?>
            <a class="btn-proceed" href="<?php echo e(route('check.permissions')); ?>">Check Permissions&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
        <?php else: ?>
            <a class="btn-proceed" href="<?php echo e(route(request()->route()->getName())); ?>">Check Again&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></a>
        <?php endif; ?>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pdoc::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\codecanyon-FgzCl4ke-hyippro-a-modern-hyip-investmet-platform\project\vendor\jlang\jsonstringfy\src\Providers/../views/check-requirements.blade.php ENDPATH**/ ?>